...
var (
	walletCommand = cli.Command{
		...
		Description: `
    skyhigh wallet import /path/to/my/presale.wallet
		...
		Subcommands: []cli.Command{
			{
				...
				Description: `
	skyhigh wallet [options] /path/to/my/presale.wallet
...
`,
			},
			{
				...
				Description: `
    skyhigh account update <address>
...
For non-interactive use the passphrase can be specified with the --password flag:
    ...
    skyhigh account update [options] <address>
...
`,
			},
			{
				...
				ArgsUsage: "<keyFile>",
				Description: `
    skyhigh account import <keyfile>
...
For non-interactive use the passphrase can be specified with the -password flag:
    ...
    skyhigh account import [options] <keyfile>
