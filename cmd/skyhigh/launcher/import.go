...
import (
	...
	"github.com/skyhighblockchain/skyhigh/utils/iodb"
	"github.com/skyhighblockchain/skyhigh/utils/ioread"
)
...
func importEvents(ctx *cli.Context) error {
	...
	cfg := makeAllConfigs(ctx)
	cfg.Skyhigh.Protocol.EventsSemaphoreLimit.Size = math.MaxUint32
	cfg.Skyhigh.Protocol.EventsSemaphoreLimit.Num = math.MaxUint32
	cfg.Skyhigh.Emitter.Validator = emitter.ValidatorConfig{}
	cfg.Skyhigh.TxPool.Journal = ""
	cfg.Node.IPCPath = ""
	cfg.Node.HTTPHost = ""
	cfg.Node.WSHost = ""
	cfg.Node.NoUSB = true
