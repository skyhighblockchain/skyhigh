...
import (
	...
	base "github.com/skyhighblockchain/push-base/eventcheck/epochcheck"
...
type Reader interface {
	base.Reader
	GetEpochRules() (skyhigh.Rules, idx.Epoch)
}
...
func CalcGasPowerUsed(e inter.EventPayloadI, rules skyhigh.Rules) uint64 {
	txsGas := uint64(0)
...
func (v *Checker) checkGas(e inter.EventPayloadI, rules skyhigh.Rules) error {
...
func CheckTxs(txs types.Transactions, rules skyhigh.Rules) error {
	maxType := uint8(0)
