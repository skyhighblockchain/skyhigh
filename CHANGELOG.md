...
* cmd: Enable reading config from file (push.toml, .json, or .yaml)

IMPROVEMENTS:

* node: major refactoring of configuration and initialization of Push node.
...
instead. 
* docs: Added sections on Push and FastSync.