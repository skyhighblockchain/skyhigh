Please check if what you want to add to `skyhigh` list meets [quality standards](https://github.com/skyhighblockchain/skyhigh/blob/master/CONTRIBUTING.md#quality-standard) before sending pull request.
