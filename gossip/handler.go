...
import (
	...
	"github.com/skyhighblockchain/push-base/eventcheck/queuedcheck"
	...
	"github.com/skyhighblockchain/skyhigh/eventcheck/parentlesscheck"
...
// newHandler returns a new Skyhigh sub protocol manager. The Skyhigh sub protocol manages peers capable
// with the Skyhigh network.
func newHandler(
	c handlerConfig,
) (
	*ProtocolManager,
...
func (pm *ProtocolManager) Stop() {
	log.Info("Stopping Skyhigh protocol")
	...
	log.Info("Skyhigh protocol stopped")
}
