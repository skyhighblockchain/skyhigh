...
func (s *Store) ApplyGenesis(blockProc BlockProc, g skyhigh.Genesis) (genesisHash hash.Hash, err error) {
...
func (s *Store) applyEpoch0Genesis(g skyhigh.Genesis) (evmBlock *evmcore.EvmBlock, err error) {
...
func (s *Store) applyEpoch1Genesis(blockProc BlockProc, g skyhigh.Genesis) (err error) {
	...
	prettyHash := func(root common.Hash, g skyhigh.Genesis) hash.Event {
