...
func (t TestBackend) GetRules() skyhigh.Rules {
	return t.rules
}

func (t TestBackend) GetPendingRules() skyhigh.Rules {
...
func TestSuggestPrice(t *testing.T) {
	backend := &TestBackend{
		block:             1,
		totalGasPowerLeft: 0,
		rules:             skyhigh.FakeNetRules(),
		pendingRules:      skyhigh.FakeNetRules(),
	}
