...
import (
	...
	"github.com/skyhighblockchain/skyhigh/ethapi"
	"github.com/skyhighblockchain/skyhigh/eventcheck"
	...
	"github.com/skyhighblockchain/skyhigh/gossip/blockproc/drivermodule"
	"github.com/skyhighblockchain/skyhigh/gossip/blockproc/eventmodule"
	"github.com/skyhighblockchain/skyhigh/gossip/blockproc/evmmodule"
	"github.com/skyhighblockchain/skyhigh/gossip/blockproc/sealmodule"
	...
	"github.com/skyhighblockchain/skyhigh/utils/gsignercache"
	"github.com/skyhighblockchain/skyhigh/utils/wgmutex"
...
func DefaultBlockProc(g skyhigh.Genesis) BlockProc {
	return BlockProc{
...
func NewService(stack *node.Node, config Config, store *Store, signer valkeystore.SignerI, blockProc BlockProc, engine push.Consensus, dagIndexer *vecmt.Index) (*Service, error) {
...
func newService(config Config, store *Store, signer valkeystore.SignerI, blockProc BlockProc, engine push.Consensus, dagIndexer *vecmt.Index) (*Service, error) {
	svc := &Service{
		config:             config,
...
// MakeProtocols constructs the P2P protocol definitions for `skyhigh`.
...
func (s *Service) Stop() error {
	defer log.Info("Skyhigh service stopped")
	s.verWatcher.Stop()
	close(s.done)
	s.emitter.Stop()
	s.pm.Stop()
